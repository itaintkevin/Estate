...
const Hero = () => {
    return(
        <div className="flex justify-center items-center px-64 h-screen overflow-hidden bg-cover bg-[url('/home/kev/Documents/Coding/blockchain/Estate/src/components/background.svg')]">
            <div className="flex flex-col justify-center items-start w-1/2 pl-8 ">
                ...
                <div className="flex justify-center items-center text-lg text-black my-20">
                    <div className='btn border text-white border-white rounded-full bg-white drop-shadow-2xl mx-5 px-2 py-2'>
